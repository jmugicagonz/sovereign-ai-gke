    ...
    template {
      ...
      spec {
        ...
        container {
          ...
          image = "europe-west1-docker.pkg.dev/sovereign-genai/frontend-genai/frontendgentailocalcontrols@sha256:91fa1636ad9938640dd75d947cc5c29e50618e0b11c6bac8f79951b863e76f49"
          name  = "rag-frontend"
          ...
          env {
            name  = "INFERENCE_ENDPOINT_MISTRAL7B"
